...
import com.sunrain.dao.UserDao;
...
import com.sunrain.exception.DataExistException;
import com.sunrain.exception.DataInsertException;
import com.sunrain.exception.DataMatchException;
import com.sunrain.exception.SystemException;
...
public class UserServiceImpl implements UserService {
	...
	@Override
	public UserSignUpResult signUp(UserSignUpForm userSignUpForm) throws SystemException {
		...
		User user = new User(userSignUpForm.getUserName(), userSignUpForm.getUserPass(), userSignUpForm.getUserEmail());
		try {
